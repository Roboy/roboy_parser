...
public class DALExecutorTest {
  ...
  protected static void runFormula(DALExecutor executor, String formula, ContextValue context,
    ...
    NLULoggerController.begin_track("formula: %s", formula);
    ...
    NLULoggerController.logs("Start:\t%s", wallString);
    NLULoggerController.logs("Result:\t%s", jsonStr);
  ...
  public Predicate<World> selectedSize(int n) {
    return x -> {
      NLULoggerController.logs("Got %d, expected %d", x.selected().size(), n);
  ...
  public void testJoin() {
    ...
    NLULoggerController.begin_track("testJoin");
  ...
  public void testSpecialSets() {
    ...
    ContextValue context = getContext(defaultBlocks);
    NLULoggerController.begin_track("testSpecial");
  ...
  public void testMerge() {
    {
      ...
      ContextValue context = getContext(defaultBlocks);
      NLULoggerController.begin_track("testMerge");
  ...
  public void testBasicActions() {
    ...
    ContextValue context = getContext(defaultBlocks);
    NLULoggerController.begin_track("testBasicActions");
  ...
  public void testRemove() {
    ...
    ContextValue context = getContext(defaultBlocks);
    NLULoggerController.begin_track("testMoreActions");
  ...
  public void troubleCases() {
    ...
    ContextValue context = getContext(defaultBlocks);
    NLULoggerController.begin_track("troubleCases");
  ...
  public void testFake() {
    ...
    ContextValue context = getContext(defaultBlocks);
    NLULoggerController.begin_track("testAnchors");
  ...
  public void testIsolation() {
    ...
    String defaultBlocks = "[[1,1,1,\"Green\",[\"S\"]],[1,1,2,\"Green\",[]],[1,1,3,\"Green\",[]],[1,1,4,\"Green\",[]]]";
    ContextValue context = getContext(defaultBlocks);
    NLULoggerController.begin_track("testIsolation");
  ...
  public void testUpdate() {
    ...
    ContextValue context = getContext(defaultBlocks);
    NLULoggerController.begin_track("testUpdate");
