...
public class DALExecutorTest {
  ...
  protected static void runFormula(DALExecutor executor, String formula, ContextValue context,
    ...
    LogController.begin_track("formula: %s", formula);
    ...
    LogController.logs("Start:\t%s", wallString);
    LogController.logs("Result:\t%s", jsonStr);
  ...
  public Predicate<World> selectedSize(int n) {
    return x -> {
      LogController.logs("Got %d, expected %d", x.selected().size(), n);
  ...
  public void testJoin() {
    ...
    LogController.begin_track("testJoin");
  ...
  public void testSpecialSets() {
    ...
    ContextValue context = getContext(defaultBlocks);
    LogController.begin_track("testSpecial");
  ...
  public void testMerge() {
    {
      ...
      ContextValue context = getContext(defaultBlocks);
      LogController.begin_track("testMerge");
  ...
  public void testBasicActions() {
    ...
    ContextValue context = getContext(defaultBlocks);
    LogController.begin_track("testBasicActions");
  ...
  public void testRemove() {
    ...
    ContextValue context = getContext(defaultBlocks);
    LogController.begin_track("testMoreActions");
  ...
  public void troubleCases() {
    ...
    ContextValue context = getContext(defaultBlocks);
    LogController.begin_track("troubleCases");
  ...
  public void testFake() {
    ...
    ContextValue context = getContext(defaultBlocks);
    LogController.begin_track("testAnchors");
  ...
  public void testIsolation() {
    ...
    String defaultBlocks = "[[1,1,1,\"Green\",[\"S\"]],[1,1,2,\"Green\",[]],[1,1,3,\"Green\",[]],[1,1,4,\"Green\",[]]]";
    ContextValue context = getContext(defaultBlocks);
    LogController.begin_track("testIsolation");
  ...
  public void testUpdate() {
    ...
    ContextValue context = getContext(defaultBlocks);
    LogController.begin_track("testUpdate");
